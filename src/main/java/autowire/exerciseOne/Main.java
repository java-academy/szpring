...
/**
 * @author Jakub Czajka
 * Zapoznaj sie z adnotacjami:
 * @ Component @ComponentScan @Value @Qualifier  @Autowierd i ich metodami, następnie wstaw adnotację w wybrane klasy tak aby kod zaczął działać
