 ...
 *
 * <ol>
 *   <li>{@link autowire.A_przykład.Main}
 *     <ul>
 *  <li>Zastanów się czy możesz uzyskać z kontekstu instancję {@link autowire.A_przykład.KonceptC}
 ...
 *   <li>Za pomocą debuggera, podczas działania programu przyglądnij się utworzonej instancji {@link org.springframework.context.ApplicationContext}. Znajdź pole {@link org.springframework.context.annotation.AnnotationConfigApplicationContext#beanFactory},
 *      następnie w nim pole {@link org.springframework.beans.factory.support.DefaultListableBeanFactory#registeredSingletons}. Zauważ zmianę przed wywołaniem {@code kontekst.getBean(KonceptD.class)} i po nim.</li>
 *    </ul>
 *   </li>
 *   <li>{@link autowire.A_przykład.KonceptAImpl}
 *     <ul>
 *       <li>
