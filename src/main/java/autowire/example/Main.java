...
/**
 * Dzień dobry,
 * Zapraszam na warsztat z podstaw wstrzykiwania zależności w Spring.
 *
 * @author Kacper Staszek
 *
 * TODO: Przeglądnij klasy zawarte w pakiecie example, jeżeli mają - wykonaj ich sekcję TODO.
 ...
 *
 */
@ComponentScan(basePackages = "autowire.example")
class Main {
