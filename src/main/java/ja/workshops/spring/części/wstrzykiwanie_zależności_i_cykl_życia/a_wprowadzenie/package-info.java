 ...
 *
 * <ol>
 *   <li>{@link ja.workshops.spring.części.wstrzykiwanie_zależności_i_cykl_życia.a_wprowadzenie.Main Main}
 *     <ul>
 *  <li>Zastanów się czy możesz uzyskać z kontekstu instancję {@link ja.workshops.spring.części.wstrzykiwanie_zależności_i_cykl_życia.a_wprowadzenie.KonceptC KonceptC}
 ...
 *    </ul>
 *   </li>
 *   <li>{@link ja.workshops.spring.części.wstrzykiwanie_zależności_i_cykl_życia.a_wprowadzenie.KonceptAImpl KonceptAImpl}
 *     <ul>
 *       <li>
 ...
 *     </ul>
 *   </li>
 *   <li>{@link ja.workshops.spring.części.wstrzykiwanie_zależności_i_cykl_życia.a_wprowadzenie.KonceptB KonceptB}
 *     <ul>
 *       <li>
 ...
 *     </ul>
 *   </li>
 *   <li>{@link ja.workshops.spring.części.wstrzykiwanie_zależności_i_cykl_życia.a_wprowadzenie.KonceptCImpl KonceptCImpl}</li>
 *   <ul>
